...
import RedesSociais from "../../common/RedesSociais";
import ImgGradePequena from "../../../assets/grade-cinza-pq.svg";
import ShortVideo from "../../../features/shortVideos/components/ShortVideo.jsx";
import useScrollTop from "../../../Hooks/useScrollTop";
import useValidRoute from "../../../Hooks/useValidRoute";

const videoByRoute = {
  "/": "https://res.cloudinary.com/du2lzkckm/video/upload/v1778994404/video-curto-deixemever_rnv1sl.mov",
  "/portfolio":
    "https://res.cloudinary.com/du2lzkckm/video/upload/v1778994406/video-curto-espelho_pfjpmp.mov",
  "/sobre":
    "https://res.cloudinary.com/du2lzkckm/video/upload/v1778994464/video-curto-coffe_v0h4g8.mp4",
  "/contato":
    "https://res.cloudinary.com/du2lzkckm/video/upload/v1778994419/video-curto-protecao_qkddnq.mov",
};
...
const Footer = () => {
  ...
  const SourceShortVideo = videoByRoute[pathname];

  if (isNotFound) return null;
  if (responsive) {
    return <FooterMobile scrollTop={scrollTop} />;
  }
  return (
    <FooterDesktop
      SourceShortVideo={SourceShortVideo}
      responsive={responsive}
    />
  );
};

const FooterMobile = ({ scrollTop }) => {
  return (
...
const FooterDesktop = ({ SourceShortVideo, responsive }) => {
  return (
